...
class MakeActionCommand extends Command
{
    ...
    echo "✅ Procedo alla creazione della singola action: $table\n";    
    passthru("php bin/generate --action=$table --with-view --with-route");
    } else {
    echo "✅ Procedo alla creazione del flusso completo per action: $table\n";
        passthru("php bin/generate --table=$table --action=$table --with-view --with-route");
    }
